...
foreach inst [$block getInsts] {
    ...
    if {[string match "*reset_tie*" $name]} {
        lappend tie_names $name
    } else {
        lappend instance_names $name
    }
}
...
# Reverse lexical order gives this shift-register-heavy netlist a different
# deterministic row topology than the generic default.
set sorted_names [concat [lsort -decreasing $instance_names] [lsort $tie_names]]
