...
lappend drt_args -or_seed $::env(DRT_OR_SEED)
...
set gnd_route_script [file join [file dirname [info script]] gnd_route.tcl]
if {![file exists $gnd_route_script]} {
    error "missing project GND route script: $gnd_route_script"
}
source $gnd_route_script
