...
if { $::env(PDN_ENABLE_RAILS) == 1 } {
    ...
    # In multilayer mode the primary M1/M2 connection was already created
    # above. Do not emit the same connect rule a second time; OpenROAD rejects
    # duplicate layer-pair connections with PDN-0186.
    if { $::env(PDN_RAIL_LAYER) != $::env(PDN_VERTICAL_LAYER) && $::env(PDN_RAIL_LAYER) != $::env(PDN_HORIZONTAL_LAYER) } {
        add_pdn_connect \
            -grid stdcell_grid \
