...
.tran 3.125e-08 5e-05
.meas tran VMAX MAX v(OUT) FROM=1.25e-05 TO=4.6875e-05
.meas tran VMIN MIN v(OUT) FROM=1.25e-05 TO=4.6875e-05
.meas tran VPP PARAM='VMAX-VMIN'
.meas tran IMAX MAX i(VDD_SRC) FROM=1.25e-05 TO=4.6875e-05
.end
