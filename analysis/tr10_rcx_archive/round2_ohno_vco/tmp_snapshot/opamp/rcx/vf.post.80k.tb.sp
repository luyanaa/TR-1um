...
RVDD PWR_SRC PWR 1
IBIAS BIAS 0 11.8u
VSIG SIG 0 SIN(2.5 0.5 80000)
RSIG SIG INP 1
RFB OUT INN 1
XU OUT PWR 0 INP INN BIAS OPAMP_OHNO
CL OUT 0 100p
.options reltol=5e-3 abstol=1e-12 vntol=1e-6 gmin=1e-12 method=gear
.tran 6.25e-08 0.0001
.meas tran VMAX MAX v(OUT) FROM=2.5e-05 TO=9.375e-05
.meas tran VMIN MIN v(OUT) FROM=2.5e-05 TO=9.375e-05
.meas tran VPP PARAM='VMAX-VMIN'
.meas tran IMAX MAX i(VDD_SRC) FROM=2.5e-05 TO=9.375e-05
.end
