...
.tran 5e-08 8e-05
.meas tran VMAX MAX v(OUT) FROM=2e-05 TO=7.5e-05
.meas tran VMIN MIN v(OUT) FROM=2e-05 TO=7.5e-05
.meas tran VPP PARAM='VMAX-VMIN'
.meas tran IMAX MAX i(VDD_SRC) FROM=2e-05 TO=7.5e-05
.end
