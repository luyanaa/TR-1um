...
.control
run
wrdata /tmp/tr10-rcx/opamp/rcx_joint/k1/cf150_ib11.8/k1_cf150_ib11.8_inv_10k_2vpp.raw time v(sig) v(inp) v(inn) v(out) v(xu.p2) @m.xu.x_1.m1[id] @m.xu.x_34.m1[id] @m.xu.x_53.m1[id] @m.xu.x_77.m1[id] @c.xu.c_52[i]
.endc
.end
