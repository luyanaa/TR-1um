...
.include "/Users/yanlu/Documents/TR-1um/analysis/tr10_rcx_vco/remediated/vco/distributed_cap_sweep/cap_each_1.000e-13/vco.post.sp"
...
.meas tran VOUT_MIN MIN v(OUT) FROM=10u TO=25u
.meas tran VOUT_MAX MAX v(OUT) FROM=10u TO=25u
.end
