* TR10-1 original-model no-PEX VCO reference.
* Models are the ISHI-KAI OpenRule1um snapshot f8862f775cad.
.include "models/mos.f8862f775cad.lib"
.include "models/passive.f8862f775cad.lib"
.include "vco.nopex.sp"
...
.meas tran VOUT_MIN MIN v(OUT) FROM=20u TO=200u
.meas tran VOUT_MAX MAX v(OUT) FROM=20u TO=200u
.end
